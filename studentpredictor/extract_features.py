...
train_df.num_subscribers.to_csv(str(Config.FEATURES_PATH / "train_labels.csv"), index=None)
test_df.num_subscribers.to_csv(str(Config.FEATURES_PATH / "test_labels.csv"), index=None)
